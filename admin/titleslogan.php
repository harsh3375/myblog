...
.rightside img{height: 150px;width: 180px;}
</style>              
        <div class="grid_10">
...
<?php
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        $websitetitle = mysqli_real_escape_string($db->link,$_POST['title']);
                        $websiteslogan = mysqli_real_escape_string($db->link,$_POST['slogan']);
